...
import com.ambabovpn.tunnel.aidl.IUltraSSHServiceInternal;
...
import com.ambabovpn.tunnel.tunnel.TunnelManagerThread;
...
import com.ambabovpn.tunnel.tunnel.DNSTunnelThread;
...
implements SkStatus.StateListener
{
	...
	public synchronized void startTunnel() {
		...
		SkStatus.logInfo(String.format("IP Address : %s", getIpPublic()));
	...
	public synchronized void stopTunnel() {
        ...
        if (mTunnelManager != null) {
            ...
            if (mTunnelThread != null) {
                ...
                SkStatus.logInfo("Stopping VPNService...");
            }
   ...
   // public static final String NOTIFICATION_CHANNEL_USERREQ_ID = "openvpn_userreq";
    ...
    private void addVpnActionsToNotification(Notification.Builder nbuilder) {
        ...
        nbuilder.addAction(R.drawable.ic_cloud_off_black_24dp,
	...
	public static PendingIntent getGraphPendingIntent(Context context) {
        ...
        intent.setComponent(new ComponentName(context, context.getPackageName() + ".AmbaboVpnProActivity"));
	...
	private ConnectivityManager.NetworkCallback networkCallback = new ConnectivityManager.NetworkCallback() {
		...
		public void onAvailable(Network net) {
			SkStatus.logDebug("Network is Available");
		}

		@Override
		public void onLost(Network net) {
			SkStatus.logDebug("Netowrk Lost");
		}

		@Override
		public void onUnavailable() {
			SkStatus.logDebug("Network is not Available");
		}
	};
