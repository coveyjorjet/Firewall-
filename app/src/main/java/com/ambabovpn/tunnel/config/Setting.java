...
import com.ambabovpn.tunnel.util.securepreferences.SecurePreferences;
...
public class Setting implements SettingsConstants
{
	...
	public Setting(Context context) {
		...
		mPrefsPrivate = SecurePreferences.getInstance(context, "SecureData", minimumConfig);
	}
	...
	*/
	...
	public void setDebugMode(boolean is) {
		SharedPreferences.Editor editor = mPrefs.edit();
	...
	public void setHideLog(boolean use){
		SharedPreferences.Editor editor = mPrefs.edit();
		editor.putBoolean(HIDE_LOG_KEY, use);
		editor.apply();
	}
	...
	public void setAutoClearLog(boolean use){
		SharedPreferences.Editor editor = mPrefs.edit();
		editor.putBoolean(AUTO_CLEAR_LOGS_KEY, use);
		editor.apply();
	}
	...
	*/
	...
	public boolean getPingForward(){
		return mPrefs.getBoolean(PINGFORWARD_KEY, false);
	}
	public void setPingForward(boolean use){
		SharedPreferences.Editor editor = mPrefs.edit();
		editor.putBoolean(PINGFORWARD_KEY, use);
		editor.apply();
	}

	public String getPingServer(){
		return mPrefs.getString(PINGURL_KEY, "clients3.google.com");
	}
	...
	public void setPingServer(String str) {
		...
		SharedPreferences.Editor editor = mPrefs.edit();
		editor.putString(PINGURL_KEY, str);
		editor.apply();
	}
	...
	*/
	...
	public static void setDefaultConfig(Context context){
		...
		editor.putBoolean(PINGFORWARD_KEY, true);
		editor.putString(PINGURL_KEY, "clients3.google.com");
